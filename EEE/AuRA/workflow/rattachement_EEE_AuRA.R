...
EEE_Auvergne_SELECT = EEE_Auvergne %>% select(CD_NOM,NOM_VALIDE,LAVERGNE)
...
#Suppression des doublons specifiques à Rhones-Alpes car BDD construite bizarrement (repetition especes)
