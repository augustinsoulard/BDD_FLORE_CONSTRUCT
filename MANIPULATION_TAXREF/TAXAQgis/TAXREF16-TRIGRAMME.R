...
setwd("C:/Users/Augustin Soulard/Documents/Nature/BDD/TAXREFv16/workflow")
TAXREFv16 <- read.delim("~/Nature/BDD/TAXREFv16/TAXREFv16.txt", encoding="UTF-8")


TAXREFv16_FLORE_FR = TAXREFv16[TAXREFv16$REGNE == "Plantae" & TAXREFv16$FR!="" & TAXREFv16$CD_REF == TAXREFv16$CD_NOM,]
